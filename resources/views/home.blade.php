                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <a href="/" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                <img src="{{asset('logoBlack.png')}}" width="180" alt="">
                            </a>
                            <p class="text-center">Oto Yedek Parça & Aksesuar</p>
                            <form action="{{route('login')}}" method="post">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <a class="text-primary fw-bold" href="/">Parolamı unuttum</a>
                                </div>
